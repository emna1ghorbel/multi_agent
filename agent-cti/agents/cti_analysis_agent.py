...
from tools.detect_behaviors import detect_behaviors
from tools.detect_patterns  import detect_patterns
from tools.rag_search       import rag_search
from tools.threat_brief     import build_threat_brief
...
def analyze_message(message: str) -> dict:
    ...
    # ------------------------------------------------------------------
    try:
        from tools.ragas_worker import submit_for_evaluation
