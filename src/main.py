...
jobs: dict[str, dict] = {}
JOBS_FILE = "/kaggle/working/jobs_store.json"
...
# ══════════════════════════════════════════════════════════════════════════════
try:
    from graph import run_pipeline as _run_pipeline
    from rag_search import rag_search as _rag_search_tool
...
#  from main import app, start_ngrok
#
#  nest_asyncio.apply()
#
